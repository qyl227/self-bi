...
public interface AIConstant {
     ...
     * deepseek
     */
    String DEEPSEEK_DEFAULT_MODEL = "deepseek-reasoner";
    String DEEPSEEK_API_URL = "https://api.deepseek.com/chat/completions";

    /**
     * openai
     */
    String OPENAI_DEFAULT_MODEL = "gpt-3.5-turbo";
    String OPENAI_API_URL = "https://api.openai.com/v1/chat/completions";

    /**
     * liaobot（第三方中转）
     */
    String LIAO_DEFAULT_MODEL = "gpt-4o-mini";
    String LIAO_API_URL = "https://ai.liaobots.work/v1/chat/completions";
}
